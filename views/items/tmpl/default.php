...
<section class="main-actions">
	...
	<a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_jfilemanager&view=jfilemanager');?>">Back to Categories</a>
</section>
				...
				<div class="panel panel-default">
					...
					<div id="collapse<?php echo $i.'in'.$index;?>" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<a class="btn btn-success" href="<?php echo JRoute::_('index.php?option=com_jfilemanager&view=files&layout=edit
								&folder_id='.$folder->id.'
								&category_id='.$this->category_id);?>">Add File</a>

							<a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_jfilemanager&view=folders&layout=edit
								&id='.$folder->id.'
								&category_id='.$this->category_id);?>">Edit Folder</a>
							...
							<a class="btn btn-primary" href="<?php echo JRoute::_('index.php?option=com_jfilemanager&view=folders&layout=edit
								&folder_id='.$folder->id.'
								&category_id='.$this->category_id);?>">Add Folder</a>
						</div>
					</div>
				</div>	
				<?php endforeach;?>
